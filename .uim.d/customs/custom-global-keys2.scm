...
(define generic-backspace-key '("backspace" "<IgnoreCase><Control>h" "<Shift>backspace"))
(define generic-backspace-key? (make-key-predicate '("backspace" "<IgnoreCase><Control>h" "<Shift>backspace")))
(define generic-delete-key '("delete" "<IgnoreCase><Control>d" "<Shift>delete"))
(define generic-delete-key? (make-key-predicate '("delete" "<IgnoreCase><Control>d" "<Shift>delete")))
